...
export const createExchange = async ({deep, Types, packageName, packageId}: {
  ...
  return { packageId, ExchangeId, symbolId, NameId, nameSymbolId, TickerId, tickerSymbolId, AvatarId, avatarSymbolId, avatarValueId, DescriptionId, descriptionSymbolId, descriptionValueId };
};